        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control col-md-12" aria-label="Default select example" name="id_karyawan">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control col-md-12" aria-label="Default select example" name="divisi">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput2">Divisi Start Date</label>
                    <input type="date" class="form-control col-md-12" name="divisi_start" id="formGroupExampleInput2" placeholder="">
                </div>

                <div class="form-group">
                    <label for="formGroupExampleInput2">Divisi End Date</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control col-md-12" aria-label="Default select example" name="jabatan">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput2">Jabatan Start Date</label>
                    <input type="date" class="form-control col-md-12" name="jabatan_start" id="formGroupExampleInput2" placeholder="">
                </div>

                <div class="form-group">
                    <label for="formGroupExampleInput2">Jabatan End Date</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control col-md-12" aria-label="Default select example" name="golongan">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput2">Golongan Start Date</label>
                    <input type="date" class="form-control col-md-12" name="golongan_start" id="formGroupExampleInput2" placeholder="">
                </div>

                <div class="form-group">
                    <label for="formGroupExampleInput2">Golongan End Date</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control col-md-12" aria-label="Default select example" name="status">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput2">Status Start Date</label>
                    <input type="date" class="form-control col-md-12" name="status_start" id="formGroupExampleInput2" placeholder="">
                </div>

                <div class="form-group">
                    <label for="formGroupExampleInput2">Status End Date</label>
